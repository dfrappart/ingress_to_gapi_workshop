...
apt install -y apt-transport-https ca-certificates curl net-tools bat bash-completion jq yq
...
kubeadm init --control-plane-endpoint=$controlplane --apiserver-advertise-address "192.168.56.82" --pod-network-cidr "100.64.0.0/16"  --service-cidr "100.65.0.0/16" #--skip-phases=addon/kube-proxy
